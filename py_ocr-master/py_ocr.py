...
# # ap.add_argument("29H-63289 29281797", "29H-63289 29281797.jpg", required=True,
# # 	help="G:\My Drive\visual_studio_code\notebook\myenv\Scripts\29H-63289 29281797.jpg")
# # ap.add_argument("thresh", "preprocess", type=str, default="thresh",
# # 	help="Bước tiền xử lý ảnh")
# args = vars(ap.parse_args())

# Đọc file ảnh và chuyển về ảnh xám
image = cv2.imread("29H-63289 29281797.jpg")
